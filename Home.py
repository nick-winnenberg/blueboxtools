...
st.markdown("**Updates V 0.2**")
st.markdown("- Added Raptor Club & Business Review as additional tools.")
...
st.subheader("Business Review")
st.text("Use an exported business review from a client record, to preapre for a business review! This includes, positions, seasonality, and turnover!")
